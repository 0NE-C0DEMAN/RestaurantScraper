"""
Scraper for Wind Chill Factory (windchillfactory.com)
...
RESTAURANT_NAME = "Wind Chill Factory"
RESTAURANT_URL = "https://www.windchillfactory.com/"

MENU_URL = "https://www.windchillfactory.com/ballston-spa-menu"
...
def fetch_menu_html() -> Optional[str]:
    ...
    headers = {
        ...
        'pragma': 'no-cache',
        'priority': 'u=0, i',
        'referer': 'https://www.windchillfactory.com/ballston-spa-homepage',
    ...
    cookies = {
        'crumb': 'BcFjpbuUWYgKZjNiNTVhY2U1YWE5ZjA5MGViMjQzMTU0ZGNiZTY4',
        'ss_cvr': '4a3ae54d-1809-4b4e-a6b1-45777cab2021|1767766287378|1767766287378|1767766287378|1',
        'ss_cvt': '1767766287378'
    }
...
def extract_menu_image_urls(html: str) -> List[str]:
    ...
    for img in images:
        ...
        if src and 'squarespace-cdn.com' in src and 'logo' not in src.lower():
            # Make sure URL is complete
            if src.startswith('//'):
                src = 'https:' + src
            elif src.startswith('/'):
                src = 'https://www.windchillfactory.com' + src
...
- section: The menu section/category this item belongs to (e.g., "Appetizers", "Entrees", "Desserts", "Ice Cream", etc.)
...
def scrape_windchillfactory() -> List[Dict]:
    ...
    for i, url in enumerate(image_urls):
        ...
        image_path = temp_dir / f"windchill_menu_{i+1}.jpg"
        if url.endswith('.png'):
            image_path = temp_dir / f"windchill_menu_{i+1}.png"
...
if __name__ == "__main__":
    items = scrape_windchillfactory()
    
    # Save to JSON
    output_dir = "output"
    output_dir_path = Path(__file__).parent.parent / output_dir
    output_dir_path.mkdir(exist_ok=True)
    output_file = output_dir_path / "windchillfactory_com.json"
