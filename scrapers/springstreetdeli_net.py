"""
Scraper for Spring Street Deli & Pizzeria (springstreetdeli.net)
Scrapes menu from PDF files: Deli Menu, Catering Menu, and Specials (Pizza & Breakfast)
...
MENU_PDFS = [
    {
        "url": "https://springstreetdeli.net/images/menus/ssdp-delimenu25.pdf",
        "menu_name": "Deli Menu",
        "menu_type": "Deli Menu"
    },
    {
        "url": "https://springstreetdeli.net/images/menus/ssdp-cateringmenu25.pdf",
        "menu_name": "Catering Menu",
        "menu_type": "Catering"
    },
    {
        "url": "https://springstreetdeli.net/images/menus/ssdp-breakfast-and-pizza.pdf",
        "menu_name": "Specials (Pizza & Breakfast)",
        "menu_type": "Specials"
    }
]
...
def download_pdf(pdf_url: str, output_path: Path) -> bool:
    ...
    try:
        ...
        headers = {
            ...
            "referer": "https://springstreetdeli.net/"
        }
...
4. **section**: The section/category name (e.g., "Appetizers", "Sandwiches", "Salads", "Soups", "Breakfast", "Pizza", "Wraps", etc.)
...
- For deli menus, sections might include: "Sandwiches", "Wraps", "Salads", "Soups", "Appetizers", "Breakfast", "Pizza", etc.
...
def scrape_springstreetdeli() -> List[Dict]:
    """Scrape menu from Spring Street Deli & Pizzeria"""
    print("=" * 60)
    print("Scraping Spring Street Deli & Pizzeria (springstreetdeli.net)")
    print("=" * 60)
    
    restaurant_name = "Spring Street Deli & Pizzeria"
    restaurant_url = "https://springstreetdeli.net/"
    ...
    for menu_info in MENU_PDFS:
        ...
        # Download PDF
        pdf_filename = f"springstreet_{menu_type.lower().replace(' ', '_')}.pdf"
...
if __name__ == "__main__":
    items = scrape_springstreetdeli()
    
    # Save to JSON
    output_dir = "output"
    output_dir_path = Path(__file__).parent.parent / output_dir
    output_dir_path.mkdir(exist_ok=True)
    output_file = output_dir_path / "springstreetdeli_net.json"
